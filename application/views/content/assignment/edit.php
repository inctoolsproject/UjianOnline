                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="assignment_type" required placeholder="ex: Try Out" value="<?= $dataAssignment->assignment_type ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="assignment_kkm" required  value="<?= $dataAssignment->assignment_kkm ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
